    ...
    return (
        <>
            <button
                ...
                className="absolute right-5 py-2 rounded-md px-4 bg-black text-white dark:bg-white dark:text-black"
            >
                Add user
            </button>
            {isOpen ? (
                <div className="fiexed inset-0 bg-black/20 backdrop-blur-2xl">
                    {' '}
